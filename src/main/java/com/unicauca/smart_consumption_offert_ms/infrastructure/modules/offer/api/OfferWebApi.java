package com.unicauca.smart_consumption_offert_ms.infrastructure.modules.offer.api;
...
public class OfferWebApi {
    ...
    public ResponseEntity<ResponseDto<OfferDto>> createOffer(
        ...
        ResponseDto<Offer> offerResponse = offerService.createOffer(offer, productId);
